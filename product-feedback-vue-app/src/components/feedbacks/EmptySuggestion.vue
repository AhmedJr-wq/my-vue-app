<template>
    <div class="max-w-[825px] h-[600px] rounded-[10px] bg-white flex justify-center items-center">
        <div class="max-w-[410px] h-[379px] flex flex-col items-center">
            <span><img src="../../assets/empty.png" alt="empty"></span>
